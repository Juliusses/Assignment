...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>CountryLayerHttpCalloutMock</apexClass>
    ...
    <classAccesses>
        <apexClass>CountryLayerSchedulerJob</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>CountryLayerSchedulerJobTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <customSettingAccesses>
        <enabled>true</enabled>
        <name>countrylayerServiceCred__c</name>
    </customSettingAccesses>
    <fieldPermissions>
        <editable>true</editable>
        <field>Country2__c.Capital__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Country2__c.Region__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Country2__c.alpha2Code__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Country2__c.alpha3Code__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Country2__c.regionalBlocs_acronym__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Lead.Last_Owner_Change__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <flowAccesses>
        ...
        <flow>Lead_Berfore_Update_Track_Owner_Change</flow>
    </flowAccesses>
    <layoutAssignments>
        <layout>Country2__c-Country Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
